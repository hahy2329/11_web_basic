...
SELECT SUBSTRING(HIRE_DATE,1,4) AS YEAR, AVG(SALARY) 
FROM EMP_TB
GROUP BY YEAR;
...
SELECT SUBSTRING(HIRE_DATE,1,4) AS YEAR, SUM(COMM)
FROM EMP_TB
GROUP BY YEAR
ORDER BY YEAR ASC;
...
SELECT SUBSTRING(HIRE_DATE, 1,4) AS YEAR, DEPT_NO, AVG(SALARY)
FROM EMP_TB
GROUP BY YEAR, DEPT_NO
ORDER BY YEAR ASC, DEPT_NO ASC;